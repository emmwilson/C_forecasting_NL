...
saveRDS(sampled_param_list_final, file = "~/C_forecasting_NL/code_for_stats/for odes/outputs/sampled_param_list_final.RDS")
```
...
jpeg("~/C_forecasting_NL/code_for_stats/for odes/outputs/heatmap_moose_Byt.jpg", height = 13, width = 15, units = "cm", res = 600)
heatmap_moose_Byt
dev.off()
...
jpeg("~/C_forecasting_NL/code_for_stats/for odes/outputs/heatmap_moose_By_yr.jpg", height = 10, width = 15, units = "cm", res = 600)
heatmap_moose_By_yr
dev.off()
...
jpeg("~/C_forecasting_NL/code_for_stats/for odes/outputs/heatmap_moose_By_yrt.jpg", height = 13, width = 15, units = "cm", res = 600)
heatmap_moose_By_yrt
dev.off()
...
remove(lPm_odes)
saveRDS(lPm_combos_rec, file = "~/C_forecasting_NL/code_for_stats/for odes/outputs/lPm_combos_rec.RDS") 
...
remove(lM_odes)
saveRDS(lM_combos_rec, file = "~/C_forecasting_NL/code_for_stats/for odes/outputs/lM_combos_rec.RDS") 


kU_odes <- param_init_runode(kU_combos)
kU_combos_rec <- get_percent_param_rec(kU_odes,kU_combos)
remove(kU_odes)
saveRDS(kU_combos_rec, file = "~/C_forecasting_NL/code_for_stats/for odes/outputs/kU_combos_rec.RDS") 


kPy_odes <- param_init_runode(kPy_combos)
kPy_combos_rec <- get_percent_param_rec(kPy_odes,kPy_combos)
remove(kPy_odes)
saveRDS(kPy_combos_rec, file = "~/C_forecasting_NL/code_for_stats/for odes/outputs/kPy_combos_rec.RDS") 


kPm_odes <- param_init_runode(kPm_combos)
kPm_combos_rec <- get_percent_param_rec(kPm_odes,kPm_combos)
remove(kPm_odes)
saveRDS(kPm_combos_rec, file = "~/C_forecasting_NL/code_for_stats/for odes/outputs/kPm_combos_rec.RDS") 

h_odes <- param_init_runode(h_combos)
h_combos_rec <- get_percent_param_rec(h_odes,h_combos)
remove(h_odes)
saveRDS(h_combos_rec, file = "~/C_forecasting_NL/code_for_stats/for odes/outputs/h_combos_rec.RDS") 

g_odes <- param_init_runode(g_combos)
g_combos_rec <- get_percent_param_rec(g_odes,g_combos)
remove(g_odes)
saveRDS(g_combos_rec, file = "~/C_forecasting_NL/code_for_stats/for odes/outputs/g_combos_rec.RDS") 

alphaUpy_odes <- param_init_runode(alphaUpy_combos)
alphaUpy_combos_rec <- get_percent_param_rec(alphaUpy_odes,alphaUpy_combos)
remove(alphaUpy_odes)
saveRDS(alphaUpy_combos_rec, file = "~/C_forecasting_NL/code_for_stats/for odes/outputs/alphaUpy_combos_rec.RDS") 
...
alphaPyU_combos_rec <- get_percent_param_rec(alphaPyU_odes,alphaPyU_combos)
remove(alphaPyU_odes)
saveRDS(alphaPyU_combos_rec, file = "~/C_forecasting_NL/code_for_stats/for odes/outputs/alphaPyU_combos_rec.RDS") 

alphaPmU_odes <- param_init_runode(alphaPmU_combos)
alphaPmU_combos_rec <- get_percent_param_rec(alphaPmU_odes,alphaPmU_combos)
remove(alphaPmU_odes)
saveRDS(alphaPmU_combos_rec, file = "~/C_forecasting_NL/code_for_stats/for odes/outputs/alphaPmU_combos_rec.RDS") 

a_odes <- param_init_runode(a_combos)
a_combos_rec <- get_percent_param_rec(a_odes,a_combos)
remove(a_odes)
saveRDS(a_combos_rec, file = "~/C_forecasting_NL/code_for_stats/for odes/outputs/a_combos_rec.RDS") 
