...
ggplot(filter(full_join(c_2023_relative,c_2022_mess2), ex_ctrl =="EX"), aes(Pm, U)) +
  geom_point() +
  geom_smooth(method = "lm")

ggplot(full_join(c_2023_relative,c_2022_mess2), aes(Py, U)) +
  geom_point() +
  geom_smooth(method = "lm") +
  xlim(c(0,15000))

ggplot(full_join(c_2023_relative,c_2022_mess2), aes(U, Py)) +
  geom_point() +
  geom_smooth(method = "lm")+
  ylim(c(0,15000))
