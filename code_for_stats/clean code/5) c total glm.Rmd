...
# including both improves model by more than 2 AICc, neither model uninfomrative because model with an additional parameter ranked below both
...
# but
# if we look at the model as a whole, to see if it is better than just FHT, AICc are different by more than 2 (and this also seems like no uninformative parameter based on step 2 of Leroux 2019)
```
